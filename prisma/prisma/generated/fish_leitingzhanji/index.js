...
const foundDirname = !regularDirname && findSync(process.cwd(), [
  "prisma\\prisma\\generated\\fish_leitingzhanji",
  "prisma\\generated\\fish_leitingzhanji",
], ['d'], ['d'], 1)[0]
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\node\\agent-casino-server\\casino-prisma\\prisma\\prisma\\generated\\fish_leitingzhanji",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
const fish_leitingzhanjiClient = getPrismaClient(config)
exports.fish_leitingzhanjiClient = fish_leitingzhanjiClient
Object.assign(exports, Prisma)

path.join(__dirname, "query_engine-windows.dll.node");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_leitingzhanji\\query_engine-windows.dll.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_leitingzhanji\\schema.prisma")
