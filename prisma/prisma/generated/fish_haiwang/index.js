...
const foundDirname = !regularDirname && findSync(process.cwd(), [
  "prisma\\prisma\\generated\\fish_haiwang",
  "prisma\\generated\\fish_haiwang",
], ['d'], ['d'], 1)[0]
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\node\\agent-casino-server\\casino-prisma\\prisma\\prisma\\generated\\fish_haiwang",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
const fish_haiwangClient = getPrismaClient(config)
exports.fish_haiwangClient = fish_haiwangClient
Object.assign(exports, Prisma)

path.join(__dirname, "query_engine-windows.dll.node");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_haiwang\\query_engine-windows.dll.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_haiwang\\schema.prisma")
