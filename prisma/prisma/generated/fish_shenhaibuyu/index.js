...
const foundDirname = !regularDirname && findSync(process.cwd(), [
  "prisma\\prisma\\generated\\fish_shenhaibuyu",
  "prisma\\generated\\fish_shenhaibuyu",
], ['d'], ['d'], 1)[0]
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\node\\agent-casino-server\\casino-prisma\\prisma\\prisma\\generated\\fish_shenhaibuyu",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
const fish_shenhaibuyuClient = getPrismaClient(config)
exports.fish_shenhaibuyuClient = fish_shenhaibuyuClient
Object.assign(exports, Prisma)

path.join(__dirname, "query_engine-windows.dll.node");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_shenhaibuyu\\query_engine-windows.dll.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_shenhaibuyu\\schema.prisma")
