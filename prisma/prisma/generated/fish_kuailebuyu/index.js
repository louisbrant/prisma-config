...
const foundDirname = !regularDirname && findSync(process.cwd(), [
  "prisma\\prisma\\generated\\fish_kuailebuyu",
  "prisma\\generated\\fish_kuailebuyu",
], ['d'], ['d'], 1)[0]
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\node\\agent-casino-server\\casino-prisma\\prisma\\prisma\\generated\\fish_kuailebuyu",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
const fish_kuailebuyuClient = getPrismaClient(config)
exports.fish_kuailebuyuClient = fish_kuailebuyuClient
Object.assign(exports, Prisma)

path.join(__dirname, "query_engine-windows.dll.node");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_kuailebuyu\\query_engine-windows.dll.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma\\prisma\\generated\\fish_kuailebuyu\\schema.prisma")
